...
output_var 'TEST_GOOGLE_CLOUD_PROJECT' "$(terraform_output 'gcp_project_id')"
...
output_file 'gcp-private-key.json' "$PRIVATE_KEY"
output_var 'TEST_GOOGLE_APPLICATION_CREDENTIALS' 'gcp-private-key.json'
